    ...
    <section className="bg-black px-6 py-24 text-white md:px-10 md:py-32">
      <div className="mx-auto grid max-w-7xl gap-14 md:grid-cols-2 md:items-center">
        <div>
          ...
          <div className="mt-8 max-w-xl space-y-6 text-base leading-8 text-white/70 md:text-lg">
            <p>
            ...
            <p>
              That is the spirit behind MSW — Made Somehow. A brand for the ones
              who keep building, even when the path is unclear.
            </p>

            <p>
              It is not about having everything figured out. It is about belief,
              motion, and finding a way forward one way or another.
            </p>
          </div>
        </div>

        <div className="flex justify-center md:justify-end">
          <div className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] p-8">
            ...
            <div className="relative flex items-center justify-center">
              <Image
                ...
                width={420}
                height={420}
                className="h-auto w-full max-w-[320px] object-contain opacity-95"
              />
            </div>
          </div>
        </div>
